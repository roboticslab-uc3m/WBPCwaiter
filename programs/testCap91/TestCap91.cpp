...
#include "TestCap91.hpp"

namespace roboticslab
{

/************************************************************************/
bool TestCap91::configure(ResourceFinder &rf) {

    std::string robot = rf.check("robot",yarp::os::Value(DEFAULT_ROBOT),"name of /robot to be used").asString();

    printf("--------------------------------------------------------------\n");
    if (rf.check("help")) {
        printf("testCap91 options:\n");
...
/************************************************************************/
bool TestCap91::configInitPosition(double speed, double acc){
...
/************************************************************************/
bool TestCap91::moveJointsInitPosition(vector<double> &trunk, vector<double>& leftArm)
{
